...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hu.martos.gym.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hu.martos.gym.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, hu.martos.gym.domain.User.class.getName());
